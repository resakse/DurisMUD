--
-- Table structure for table `DURIS_INFORMATION`
--

DROP TABLE IF EXISTS `DURIS_INFORMATION`;
CREATE TABLE `DURIS_INFORMATION` (
...
--
-- Table structure for table `TRUMAN_FILE`
--

DROP TABLE IF EXISTS `TRUMAN_FILE`;
CREATE TABLE `TRUMAN_FILE` (
