...
/* Warrior Specs */
  ...
  SPEC_SKILL_ADD(CLASS_ANTIPALADIN, 56, 100, SPEC_DEFILER);
...
/* Anti-paladin Specs */
  ...
  SPEC_SKILL_ADD(CLASS_ANTIPALADIN, 0, 0, SPEC_DEFILER);
...
*/
  ...
  */
  ...
  SPEC_SKILL_ADD(CLASS_ANTIPALADIN, 30, 100, SPEC_DEFILER);
...
// Creating this bogus skill so only the person being throat crushed receives the wear off message.
  ...
  SKILL_ADD(CLASS_AVENGER, 1, 100);
  SKILL_ADD(CLASS_ETHERMANCER, 1, 60);
  SPEC_SKILL_ADD(CLASS_ANTIPALADIN, 1, 100, SPEC_DEFILER);
  ...
  SPEC_SKILL_ADD(CLASS_ANTIPALADIN, 41, 100, SPEC_DEFILER);
