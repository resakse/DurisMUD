...
#define RACE_GARGOYLE        31 /* mob race code: MG */
#define RACE_F_ELEMENTAL     32 /* mob race code: EF */
#define RACE_A_ELEMENTAL     33 /* mob race code: EA */
#define RACE_W_ELEMENTAL     34 /* mob race code: EW */
#define RACE_E_ELEMENTAL     35 /* mob race code: EE */
#define RACE_DEMON           36 /* mob race code: X  */
#define RACE_DEVIL           37 /* mob race code: Y  */
#define RACE_UNDEAD          38 /* mob race code: U  */
#define RACE_VAMPIRE         39 /* mob race code: UV */
#define RACE_GHOST           40 /* mob race code: UG */
#define RACE_LYCANTH         41 /* mob race code: L  */
#define RACE_GIANT           42 /* mob race code: G  */
#define RACE_HALFORC         43 /* mob race code: H2 */
#define RACE_GOLEM           44 /* mob race code: OG */
#define RACE_FAERIE          45 /* mob race code: HF */
#define RACE_DRAGON          46 /* mob race code: D  */
#define RACE_DRAGONKIN       47 /* mob race code: DK */
#define RACE_REPTILE         48 /* mob race code: R  */
#define RACE_SNAKE           49 /* mob race code: RS */
#define RACE_INSECT          50 /* mob race code: I  */
#define RACE_ARACHNID        51 /* mob race code: AS */
#define RACE_AQUATIC_ANIMAL  52 /* mob race code: F  */
#define RACE_FLYING_ANIMAL   53 /* mob race code: B  */
#define RACE_QUADRAPED       54 /* mob race code: AE */
#define RACE_PRIMATE         55 /* mob race code: AA */
#define RACE_HUMANOID        56 /* mob race code: H  */
#define RACE_ANIMAL          57 /* mob race code: A  */
#define RACE_PLANT           58 /* mob race code: VT */
#define RACE_HERBIVORE       59 /* mob race code: AH */
#define RACE_CARNIVORE       60 /* mob race code: AC */
#define RACE_PARASITE        61 /* mob race code: AP */
#define RACE_BEHOLDER        62 /* mob race code: BH */
#define RACE_DRACOLICH       63 /* mob race code: UD */
#define RACE_SLIME           64 /* mob race code: SL */
#define RACE_ANGEL           65 /* mob race code: AN */
#define RACE_RAKSHASA        66 /* mob race code: RA */
#define RACE_CONSTRUCT       67 /* mob race code: CN */
#define RACE_EFREET          68 /* mob race code: E  */
#define RACE_SNOW_OGRE       69 /* mob race code: SO */
#define RACE_BEHOLDERKIN     70 /* mob race code: BK */
#define RACE_ZOMBIE          71 /* mob race code: ZO */
#define RACE_SPECTRE         72 /* mob race code: SP */
#define RACE_SKELETON        73 /* mob race code: SK */
#define RACE_WRAITH          74 /* mob race code: WR */
...
#define LAST_RACE            99 /* 98 races on duris! */
