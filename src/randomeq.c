...
const struct randomeq_slots slot_data[MAX_SLOT + 1] = {
  ...
  {52, "&+Lskull&N", 1.4, 0.5, ITEM_WEAR_HEAD, 2, 0},
  {53, "&+Lhorn&N", 1.0, 0.0, ITEM_WEAR_HORN, 1, 0},
  {54, "&+Lchainmail&N", 1.5, 1.3, ITEM_WEAR_BODY, 3, 0},
  {55, "&+Lcuirass&N", 1.3, 1.2, ITEM_WEAR_BODY, 2, 0},
  {56, "&+Lbreastplate&N", 1.4, 1.5, ITEM_WEAR_BODY, 2, 0},
  {57, "&+Lamulet&N", 1.1, 0.0, ITEM_WEAR_NECK, 2, 0},
  {58, "&+Lmedallion&N", 1.2, 0.0, ITEM_WEAR_NECK, 2, 0},
  {59, "&+Lcharm&N", 1.0, 0.0, ITEM_WEAR_NECK, 2, 0},
  {60, "&+Lpendant&N", 1.2, 0.0, ITEM_WEAR_NECK, 2, 0},
  {61, "&+Ltorque&N", 1.2, 1.0, ITEM_WEAR_NECK, 2, 0},
  {62, "&+Lgorget&n", 1.3, 1.5, ITEM_WEAR_NECK, 3, 0},
  {63, "&+Lcap&N", 1.1, 0.3, ITEM_WEAR_HEAD, 2, 0},
  {64, "&+Lcoif&N", 1.0, 1.1, ITEM_WEAR_HEAD, 2, 0},
  {65, "&+Lcirclet&N", 1.4, 0.6, ITEM_WEAR_HEAD, 2, 0},
  {66, "&+Ltiara&N", 1.3, 0.3, ITEM_WEAR_HEAD, 2, 0},
  {67, "&+Lhood&N", 1.2, 0.8, ITEM_WEAR_HEAD, 2, 0},
  {68, "&+Lclaws&N", 1.2, 1.0, ITEM_WEAR_HANDS, 2, 0},
  {69, "&+Lbuckler&N", 1.0, 1.0, ITEM_WEAR_SHIELD, 3, 0},
  {70, "&+Ltower shield&N", 1.1, 2.0, ITEM_WEAR_SHIELD, 3, 0},
  {71, "&+Lcord&n", 0.9, 0.1, ITEM_WEAR_TAIL, 2, 0},
...
*/
  ...
  {79, "&+Ldrusus&n", 0.8, 0.8, ITEM_WIELD, 2, WEAPON_SHORTSWORD},
  ...
  {87, "&+ycudgel&n", 1.0, 1.0, ITEM_WIELD, 2, WEAPON_CLUB},
  {88, "&+Lscythe&n", 1.0, 1.0, ITEM_WIELD, 2, WEAPON_SICKLE},
  {89, "&+Wscimitar&n", 1.1, 0.9, ITEM_WIELD, 2, WEAPON_LONGSWORD},
  {90, "&+Btrident&n", 1.0, 1.0, ITEM_WIELD, 2, WEAPON_TRIDENT},
  {91, "&+Lmace&n", 1.0, 1.0, ITEM_WIELD, 2, WEAPON_MACE},
  {92, "&+Lpronged fork&n", 1.0, 1.0, ITEM_WIELD, 2, WEAPON_TRIDENT},
  {93, "&+Lwhip&n", 1.1, 0.9, ITEM_WIELD, 2, WEAPON_WHIP},
  {94, "&+Lknife&n", 0.8, 0.8, ITEM_WIELD, 2, WEAPON_DAGGER},
  {95, "&+Lshillelagh&n", 1.2, 1.2, ITEM_WIELD, 3, WEAPON_CLUB},
  {96, "&+Lrod&n", 1.0, 1.0, ITEM_WIELD, 2, WEAPON_CLUB},
  {97, "&+Llongbow&n", 1.0, 1.0, ITEM_WIELD, 3, 0},
  {98, "&+Lstiletto&n", 1.0, 0.6, ITEM_WIELD, 2, WEAPON_DAGGER},
  {99, "&+Lbastard sword&n", 1.1, 1.2, ITEM_WIELD, 3, WEAPON_2HANDSWORD},
  {100, "&+Whand axe&n", 0.9, 1.1, ITEM_WIELD, 2, WEAPON_AXE},
  {101, "&+yquarterstaff&n", 1.4, 0.9, ITEM_WIELD, 2, WEAPON_CLUB},
  {102, "&+Lleister&n", 1.1, 1.2, ITEM_WIELD, 3, WEAPON_TRIDENT},
